...
- **Project Code**: `PPMCP`
- **Project Name**: PhotoPrism MCP Server
- **Letta Agent ID**: `agent-cc2aaa60-731d-41a8-99f4-de7154131a23`

## Workflow Instructions

1. **Before starting work**: Search Huly for related issues using `huly-mcp` with project code `PPMCP`
2. **Issue references**: All issues for this project use the format `PPMCP-XXX` (e.g., `PPMCP-123`)
...
**Project PM Agent:** `Huly - PhotoPrism MCP Server` (agent-cc2aaa60-731d-41a8-99f4-de7154131a23)
...
```json
{
  ...
  "agent": "Huly - PhotoPrism MCP Server",
  "message": "<your report>",
  "caller_directory": "/opt/stacks/photoprism-mcp"
}
```
...
**Project**: PhotoPrism MCP Server (`PPMCP`)
**Path**: `/opt/stacks/photoprism-mcp`
